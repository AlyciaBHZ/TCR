...
# Tests importance of conditioning dropout
# ============================================
...
# Output directory
OUT_DIR="flowtcr_fold/FlowTCR_Gen/saved_model/stage2/ablation_no_cfg"
...
echo "Mode: ABLATION - No CFG (drop_prob=0)" | tee -a "$LOG_FILE"
...
stdbuf -oL python -u flowtcr_fold/FlowTCR_Gen/train.py --ablation no_cfg 2>&1 | tee -a "$LOG_FILE"
