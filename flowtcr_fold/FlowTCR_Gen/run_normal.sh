#!/bin/bash
#SBATCH --job-name=FlowGen_normal
...
# ============================================
# FlowTCR-Gen Training (Stage 2) - NORMAL
...
echo "Mode: NORMAL (full model)" | tee -a "$LOG_FILE"
...
# Training
stdbuf -oL python -u flowtcr_fold/FlowTCR_Gen/train.py 2>&1 | tee -a "$LOG_FILE"
